...
<div id="single-wrapper">
    <form action="{{ route('register') }}" method="POST" class="frm-single">
        ...
        <div class="inside">
            ...
            <!-- /.frm-input -->
            <div class="frm-input"><input type="text" placeholder="Full Name" name="name" class="frm-inp"><i class="fa fa-user frm-ico"></i></div>
            <!-- /.frm-input -->
            ...
            <div class="frm-input"><input type="password" name="password_confirmation" placeholder="Re enter Password" class="frm-inp"><i class="fa fa-lock frm-ico"></i></div>
            <!-- /.frm-input -->
